...
- [x] **Task 1:** Update dashboard page to include new cards
- [x] **Task 2:** Implement trending calculation function
- [x] **Task 3:** Add sparkline charts to each card (Recharts)
- [x] **Task 4:** Fetch "Próximos Vencimentos" data
- [x] **Task 5:** Fetch "Oportunidades Aguardando" data
- [x] **Task 6:** Create helper for days calculation and formatting
- [x] **Task 7:** Test trending logic and visualizations
- [x] **Task 8:** Ensure RLS works for viewers (read-only)
- [x] **Task 9:** Run build, lint, typecheck
...
### Completion Notes:
- ✅ Hook `use-dashboard-metrics.ts`: fetching, trending calc (mês atual vs anterior), sparkline semanal (4 semanas)
- ✅ Componente `Sparkline.tsx`: mini AreaChart Recharts, sem animação, cor configurável
- ✅ Dashboard refatorado: 4 KPI cards com TrendBadge (↑/↓/→) + Sparkline por card
- ✅ Tabela "Próximos Vencimentos": top 5 contratos expirando, dias em vermelho se ≤ 10
- ✅ Tabela "Oportunidades Aguardando": top 5 em aberto há +7d, dias em vermelho se > 14
- ✅ Link "Ver Relatórios" → `/dashboard/reports/contracts`
- ✅ RLS mantido via Supabase (company_id filter, viewers read-only)
- ✅ npm run lint: PASS
- ✅ npm run build: PASS
- ✅ npx tsc --noEmit: PASS

### Change Log:
- 2026-02-27: Implementação completa Story 3.5
