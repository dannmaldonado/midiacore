...
- [ ] **Task 1:** Create page `src/app/dashboard/reports/contracts/page.tsx`
- [ ] **Task 2:** Fetch contract data with filters (period, status, shopping)
- [ ] **Task 3:** Calculate metrics (totals, counts, averages)
- [ ] **Task 4:** Implement charts (Recharts library)
- [ ] **Task 5:** Create summary table (top 10 shoppings)
- [ ] **Task 6:** Implement CSV/PDF export (admin only)
- [ ] **Task 7:** Test filters and export functionality
